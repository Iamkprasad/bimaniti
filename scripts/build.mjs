...
<html lang="en">
<head>
    <script>(function(){try{var t=localStorage.getItem('theme'),p=window.matchMedia('(prefers-color-scheme: dark)').matches;if(t==='dark'||(!t&&p)){document.documentElement.classList.add('dark');}else{document.documentElement.classList.remove('dark');}}catch(e){}})();</script>
    <style>html{background-color:#F7F6F2}html.dark{background-color:#141410!important;color:#E8E4DC}</style>
    <meta charset="UTF-8">
...
:root{--font-display:'Playfair Display',Georgia,serif;--font-body:'DM Sans',system-ui,sans-serif;--bg-primary:#F7F6F2;--bg-secondary:#EFECE6;--text-primary:#1F1F1F;--text-secondary:#3D3D3D;--text-muted:#666666;--accent:#355E3B;--accent-hover:#29492E;--accent-gold:#B08D57;--border:#D8D4CB;--card-bg:#FFFFFF;--nav-bg:#F7F6F2;--alert:#B94040;--max-w:1160px;--article-w:680px;--radius:4px;--transition:200ms ease}
.dark{--bg-primary:#141410;--bg-secondary:#1C1C18;--text-primary:#E8E4DC;--text-secondary:#C0BAB0;--text-muted:#8A8A84;--accent:#8AAA7A;--accent-hover:#A0BE90;--accent-gold:#D4AF37;--border:#2E2E28;--card-bg:#1E1E1A;--nav-bg:#141410}
body{background:var(--bg-primary);color:var(--text-secondary);font-family:var(--font-body);font-size:16px;font-weight:400;-webkit-font-smoothing:antialiased;line-height:1.7;overflow-x:hidden}
a{text-decoration:none;color:inherit}
h1,h2,h3,h4,h5,h6{font-family:var(--font-display);font-weight:400;line-height:1.2;color:var(--text-primary)}
::selection{background:rgba(53,94,59,.2);color:var(--text-primary)}
...
.logo-title{font-family:'Playfair Display',Georgia,serif;font-weight:700;font-size:32px;fill:#1F1F1F}
.logo-niti{fill:#355E3B}
.logo-sub{font-family:'DM Sans',system-ui,sans-serif;font-weight:600;font-size:9.5px;fill:#5A5A5A;letter-spacing:2.2px}
html.dark .logo-title{fill:#E8E4DC}
html.dark .logo-niti{fill:#8AAA7A}
html.dark .logo-sub{fill:#A0A09A}
html.dark .n-stroke{stroke:#8AAA7A!important}
...
.post-content{max-width:680px;margin:0 auto;font-family:var(--font-body);font-size:16px;font-weight:400;line-height:1.7;color:var(--text-secondary)}
...
.post-content>p:first-of-type::first-letter{font-family:'Playfair Display',serif;font-size:52px;font-weight:700;color:var(--accent);float:left;line-height:.82;margin:6px 10px 0 0}
...
<body>
    ...
    <nav class="navbar" aria-label="Main navigation">
        <div class="nav-container">
            <a href="../" class="logo" aria-label="BimaNiti — Insurance &amp; Market Analysis"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 340 58" class="site-logo"><g transform="translate(4, 6.5)"><rect class="bg-box" x="0" y="0" width="54" height="45" rx="4" fill="#355E3B"/><path class="b-white" fill="#FFFFFF" d="M 8,8 L 24,8 C 29,8 32,10.5 32,14.5 C 32,17.5 30,19.5 27,20.5 C 31,21.5 33,24 33,28.5 C 33,33 29.5,37 24,37 L 8,37 Z M 14,13 L 14,19 L 23,19 C 25.5,19 27,17.8 27,16 C 27,14.2 25.5,13 23,13 Z M 14,24 L 14,32 L 24,32 C 26.8,32 28.5,30.5 28.5,28 C 28.5,25.5 26.8,24 24,24 Z"/><rect class="b-white" fill="#FFFFFF" x="38" y="8" width="6" height="29"/><path class="n-stroke" d="M 39,10 L 73,36.5" stroke="#355E3B" stroke-width="5.5" stroke-linecap="square" fill="none"/><path class="n-stroke" d="M 73,8 L 73,37" stroke="#355E3B" stroke-width="5.5" stroke-linecap="square" fill="none"/></g><text x="96" y="35" class="logo-title">Bima<tspan class="logo-niti">Niti</tspan></text><text x="96" y="50" class="logo-sub">INSURANCE &amp; MARKET ANALYSIS</text></svg></a>
